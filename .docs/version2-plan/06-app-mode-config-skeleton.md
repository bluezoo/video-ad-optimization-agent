...
4. Do not change `populate_mock_data()`, `app/agent.py:105`'s unconditional import-time initialization, any tool in `app/tools/`, or any agent instruction in this phase.
