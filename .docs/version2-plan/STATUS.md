...
| 9 | `09` | prompt-and-agent-generalization | implement in progress | version_2_prompt-generalization | - | 2026-07-21 | plan approved (8 tasks + stabilize); Option B archetype registry |
