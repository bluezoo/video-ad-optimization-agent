...
| 11a | `11` | audience-provider-seam (port) | PR open | version_2_live-bluezoo-adapter | [#12](https://github.com/bluezoo/video-ad-optimization-agent/pull/12) | 2026-07-22 | F3+F4 PASS, fail-closed smoke PASS, final review clean; awaiting owner merge confirmation |
