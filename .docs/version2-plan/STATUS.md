...
| 9 | `09` | prompt-and-agent-generalization | PR open | version_2_prompt-generalization | [#10](https://github.com/bluezoo/video-ad-optimization-agent/pull/10) | 2026-07-22 | demo verify PASS (F1 2/2, F5 2/2); review: ready to merge; DISCOVERY Q19 (integration evals vacuous) awaiting owner decision |
