...
| 14a | `14a` | image-model-upgrade-nano-banana | plan in progress | version_2_model-upgrades | - | 2026-07-22 | combined ws with 14b + agent-default pull-forward from Phase 16 step 3; one branch/PR, working-docs/14-model-upgrades/ |
| 14b | `14b` | video-model-upgrade-omni-flash | plan in progress | version_2_model-upgrades | - | 2026-07-22 | combined ws with 14a (same branch/PR); sequenced 14a -> 14b -> agent default |
