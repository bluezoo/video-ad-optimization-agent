...
| 2 | `03` | metrics-glossary-and-terminology | implement in progress | version_2_metrics-glossary | - | 2026-07-16 | plan approved (e7b1ed5); 2 tasks: write docs/METRICS.md, wire links + phase-doc amendment |
