...
| 14a | `14a` | image-model-upgrade-nano-banana | merged | version_2_model-upgrades | [#14](https://github.com/bluezoo/video-ad-optimization-agent/pull/14) | 2026-07-22 | squash-merged e3c771d (#14); comparison keeps gemini-3-pro-image default; agent default now gemini-3.6-flash |
| 14b | `14b` | video-model-upgrade-omni-flash | merged | version_2_model-upgrades | [#14](https://github.com/bluezoo/video-ad-optimization-agent/pull/14) | 2026-07-22 | squash-merged e3c771d (#14); Veo polling consolidated+tested; Omni NO-GO (previous_interaction_id unsupported), steps 4-6 deferred w/ provenance |
