...
| 7 | `07` | rpi-across-creatives-chart | verify in progress | version_2_rpi-chart | - | 2026-07-19 | all 4 tasks implemented + reviewed (ea97b50); full make test green; running F3 (updated) + new F4 demo scenarios |
