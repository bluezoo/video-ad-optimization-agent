...
| 1 | `02` | bug-fixes-and-cleanup | PR open | version_2_bug-fixes-and-cleanup | [#2](https://github.com/bluezoo/video-ad-optimization-agent/pull/2) | 2026-07-14 | all verified (e2e 0 failed, F1+F2 PASS, review clean); held for owner review |
| 2 | `03` | metrics-glossary-and-terminology | not started | - | - | 2026-07-13 | - |
