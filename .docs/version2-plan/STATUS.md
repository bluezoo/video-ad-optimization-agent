...
| 9 | `09` | prompt-and-agent-generalization | kickoff in progress | version_2_prompt-generalization | - | 2026-07-21 | Phase 8 merged (5d3e1f8); prompt approach A-D is the working-doc design decision (see 09 doc amendment) |
