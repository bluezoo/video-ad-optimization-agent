...
| 9 | `09` | prompt-and-agent-generalization | verify in progress | version_2_prompt-generalization | - | 2026-07-22 | 8 tasks + polish done; DISCOVERY: integration evals vacuous under pytest (Q19); demo verify F1/F5.1/F5.2 |
