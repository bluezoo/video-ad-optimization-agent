...
| 7 | `07` | rpi-across-creatives-chart | implement in progress | version_2_rpi-chart | - | 2026-07-19 | plan approved (f27e3c7); 4 tasks: Option A data change, comparison tool, matplotlib chart + numpy-AE fix, wiring/scenarios |
