...
| 9 | `09` | prompt-and-agent-generalization | plan in progress | version_2_prompt-generalization | - | 2026-07-21 | working doc approved: Option B archetype registry; 3 kickoff discoveries amended into docs 02/09 |
