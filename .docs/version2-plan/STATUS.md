...
| 8 | `08` | product-schema-generalization | plan in progress | version_2_product-schema | - | 2026-07-20 | working doc approved; owner: category Option A (themed taxonomy + always-on) + Q7 answered as multi-vertical retail core test set |
