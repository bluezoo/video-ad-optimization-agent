...
| 7 | `07` | rpi-across-creatives-chart | plan in progress | version_2_rpi-chart | - | 2026-07-19 | working doc approved; owner picked Option A (per-creative seeded RPI factor); numpy-AE discovery fix folded in |
