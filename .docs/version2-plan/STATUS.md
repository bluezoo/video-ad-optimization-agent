...
| 8 | `08` | product-schema-generalization | implement in progress | version_2_product-schema | - | 2026-07-20 | plan approved w/ owner self-service amendment (insert_product substrate); executing 5 tasks + stabilize-until-green loop |
