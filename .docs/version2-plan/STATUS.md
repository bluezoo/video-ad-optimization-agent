...
| 11a | `11` | audience-provider-seam (port) | verify in progress | version_2_live-bluezoo-adapter | - | 2026-07-22 | working doc approved (lean visit-interval seam + APP_MODE factory, fail-closed connected); carried items 1+2 in scope |
