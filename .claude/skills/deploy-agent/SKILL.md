...
**Region gotcha**: All Gemini 3 / Veo models (`gemini-3.5-flash`, `gemini-3-pro-image`, `veo-3.1-generate-001`) require `global` region. If you see `Publisher Model ... was not found (404)`, the deployment is pointed at a regional endpoint instead of `global`.
